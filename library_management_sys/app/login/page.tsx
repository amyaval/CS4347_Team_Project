...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      router.replace("/home"); // <-- replaced navigate('/home')
    } else {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(180deg, #FFC5C5 0%, #FFFFFF 23%)" }}
    >
      <div className="w-full max-w-md px-8">
        <div className="flex justify-center mb-8">
          <div className="flex gap-1">
            <div
              ...
              style={{ borderBottomColor: "#B60000" }}
            ></div>
            <div
              className="w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-b-[30px]"
              style={{ borderBottomColor: "#B60000" }}
        ...
        <div className="bg-white rounded-lg p-8 shadow-lg">
          ...
          <p className="mb-6" style={{ color: "#929292" }}>
            Please sign in below with an admin account
          </p>
